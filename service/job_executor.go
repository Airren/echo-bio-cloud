...
curl -X POST http://www.echo-bio.cn:8088/api/v1/internal/file_upload?analysis_job_id=${ANALYSIS_JOB_ID}&account_id=${ACCOUNT_ID} --form 'file=@"/tmp/analysis_job/results.tar.gz"';`
